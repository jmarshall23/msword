...
#ifdef OPUS_X64
/* StringMap supplied counted-string initializers to the 16-bit compiler.
 * Preserve those exact ST bytes explicitly for the native compiler. */
static const CHAR stRpfLegal[] = "\0221.1.1.1.1.1.1.1.1.";
static const CHAR stRpfOutline[] = "\022I.A.1.a)1)a)i)a)i)";
static const CHAR stRpfSequence[] = "\0221.1.1.1.1.1.1.1.1.";
static const CHAR * const mprpfM1stFormat[] =
{
	stRpfLegal, stRpfOutline, stRpfSequence
};
#else
