...
#ifdef OPUS_X64
/* Counted string formerly emitted by the localization StringMap pass. */
csconst char stDotSlash[] = { 2, '.', '\\' };
#else
...
#ifdef OPUS_X64
/* The longest counted profile key is UTIL-PATH: one length byte plus nine
 * characters.  These are the original English keys normally generated by
 * the absent localization pass. */
csconst CHAR mpfpistName[][10] =
{
	{ 8, 'D', 'O', 'T', '-', 'P', 'A', 'T', 'H' },
	{ 8, 'I', 'N', 'I', '-', 'P', 'A', 'T', 'H' },
	{ 9, 'U', 'T', 'I', 'L', '-', 'P', 'A', 'T', 'H' }
