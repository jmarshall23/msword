...
#ifdef OPUS_X64
/* StringMap was a Microsoft C resource-string compiler extension.  Mark its
 * counted strings and derive their byte count at use sites on native C. */
#undef StShared
#define StShared(s) "\377" s
#define CchStz(stz) ((unsigned char)(stz)[0] == 0xff ? \
		(int) strlen(&(stz)[1]) : (unsigned char)(stz)[0])
#else
#define CchStz(stz) ((unsigned char)(stz)[0])
#endif
		...
		if (iae < iaepicDateMax)
			...
			if (iae != 0)
				...
				bltbx((CHAR FAR *) &(rgaepicDate[iae - 1].stzPic[1]),
						(CHAR FAR *) sz,
						CchStz(rgaepicDate[iae - 1].stzPic));
				}
			else
				{
	...
	case abmEnum:
		if (iae < iaelpPNumMax)
			...
			bltbx((CHAR FAR *) &(rgaelpPNum[iae].stzInstName[1]),
					(CHAR FAR *) sz,
					CchStz(rgaelpPNum[iae].stzInstName));
			return fTrue;
			}
		return fFalse;
	case abmAppend:
		...
		bltbx((CHAR FAR *) &(rgaelpPNum[iae].stzInstActual[1]),
				(CHAR FAR *) pch,
				CchStz(rgaelpPNum[iae].stzInstActual));
	...
	case abmEnum:
		if (iae < iaelpTOCMax)
			...
			bltbx((CHAR FAR *) &(rgaelpTOC[iae].stzInstName[1]),
					(CHAR FAR *) sz,
					CchStz(rgaelpTOC[iae].stzInstName));
			return fTrue;
			}
		return fFalse;
	case abmAppend:
		...
		bltbx((CHAR FAR *) &(rgaelpTOC[iae].stzInstActual[1]),
				(CHAR FAR *) szT,
				CchStz(rgaelpTOC[iae].stzInstActual));
		AppendSzWordSz(sz, szT, ichMax);
		return (fTrue);
		}
	Assert (fFalse);
	...
	case abmEnum:
		if (iae < iaelpIndexMax)
			...
			bltbx((CHAR FAR *) &(rgaelpIndex[iae].stzInstName[1]),
					(CHAR FAR *) sz,
					CchStz(rgaelpIndex[iae].stzInstName));
			return fTrue;
			}
		return fFalse;
	case abmAppend:
		...
		bltbx((CHAR FAR *) &(rgaelpIndex[iae].stzInstActual[1]),
				(CHAR FAR *) szT,
				CchStz(rgaelpIndex[iae].stzInstActual));
		AppendSzWordSz(sz, szT, ichMax);
		return (fTrue);
		}
	Assert (fFalse);
	...
	case abmEnum:
		if (iae < iaelpPrintMax)
			...
			bltbx((CHAR FAR *) &(rgaelpPrint[iae].stzInstName[1]),
					(CHAR FAR *) sz,
					CchStz(rgaelpPrint[iae].stzInstName));
			return fTrue;
			}
		return fFalse;
	case abmAppend:
		...
		bltbx((CHAR FAR *) &(rgaelpPrint[iae].stzInstActual[1]),
				(CHAR FAR *) szT,
				CchStz(rgaelpPrint[iae].stzInstActual));
		AppendSzWordSz(sz, szT, ichMax);
		return (fTrue);
		}
	Assert (fFalse);
	...
	case abmEnum:
		if (iae < iaelpEqMax)
			...
			bltbx((CHAR FAR *) &(rgaelpEq[iae].stzInstName[1]),
					(CHAR FAR *) sz,
					CchStz(rgaelpEq[iae].stzInstName));
			return fTrue;
			}
		return fFalse;
	case abmAppend:
		...
		bltbx((CHAR FAR *) &(rgaelpEq[iae].stzInstActual[1]),
				(CHAR FAR *) szT,
				CchStz(rgaelpEq[iae].stzInstActual));
		AppendSzWordSz(sz, szT, ichMax);
		return (fTrue);
		}
	Assert (fFalse);
