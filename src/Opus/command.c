...
#define X64_UNDO_ST(textValue) \
	{ (CHAR)(sizeof(textValue) - 1), textValue }

csconst X64UNDO_ST rgstUndo [] =
	{
	X64_UNDO_ST("Typing"),
	X64_UNDO_ST("Formatting"),
	X64_UNDO_ST("Delete"),
	X64_UNDO_ST("Change Bookmark"),
	X64_UNDO_ST("Insertion"),
	X64_UNDO_ST("Move"),
	X64_UNDO_ST("Revision"),
	X64_UNDO_ST("Edit"),
	X64_UNDO_ST("CopyToFrom"),
	X64_UNDO_ST("Expand Glossary"),
	X64_UNDO_ST("Define Glossary"),
	X64_UNDO_ST("Page Break"),
	X64_UNDO_ST("Replace"),
	X64_UNDO_ST("Edit Table"),
	X64_UNDO_ST("Promote/Demote"),
	X64_UNDO_ST("Format Table"),
	X64_UNDO_ST("Insert Table"),
	X64_UNDO_ST("Split Table")
	};
#undef X64_UNDO_ST
#else
...
#ifdef OPUS_X64
#define X64_KCD(keyValue, textValue) \
	{ keyValue, { (CHAR)(sizeof(textValue) - 1), textValue } }
csconst KCD vrgkcd [] =
	{
	X64_KCD(VK_CANCEL, "ScLk"),
	X64_KCD(kcBackSpace, "BkSp"),
	X64_KCD(kcTab, "Tab"),
	X64_KCD(kcReturn, "Enter"),
	X64_KCD(kcEscape, "Esc"),
	X64_KCD(kcInsert, "Ins"),
	X64_KCD(kcDelete, "Del"),
	X64_KCD(kcSpace, "Space"),
	X64_KCD(kcHelp, "Help"),
	X64_KCD(VK_NUMPAD0, "NumPad 0"),
	X64_KCD(VK_NUMPAD1, "NumPad 1"),
	X64_KCD(VK_NUMPAD2, "NumPad 2"),
	X64_KCD(VK_NUMPAD3, "NumPad 3"),
	X64_KCD(VK_NUMPAD4, "NumPad 4"),
	X64_KCD(VK_NUMPAD5, "NumPad 5"),
	X64_KCD(VK_NUMPAD6, "NumPad 6"),
	X64_KCD(VK_NUMPAD7, "NumPad 7"),
	X64_KCD(VK_NUMPAD8, "NumPad 8"),
	X64_KCD(VK_NUMPAD9, "NumPad 9"),
	X64_KCD(kcClear, "NumPad 5"),
	X64_KCD(kcNPPlus, "NumPad +"),
	X64_KCD(kcNPMinus, "NumPad -"),
	X64_KCD(kcNPMult, "NumPad *"),
	X64_KCD(kcNPDiv, "NumPad /"),
	X64_KCD(VK_DECIMAL, "NumPad ."),
	X64_KCD(kcUp, "Up"),
	X64_KCD(kcDown, "Down"),
	X64_KCD(kcLeft, "Left"),
	X64_KCD(kcRight, "Right"),
	X64_KCD(kcBeginLine, "Home"),
	X64_KCD(kcEndLine, "End"),
	X64_KCD(kcPageUp, "PgUp"),
	X64_KCD(kcPageDown, "PgDn")
	};
#undef X64_KCD
#else
csconst KCD vrgkcd [] =
