...
#ifdef OPUS_X64
static const CHAR stSortTitle[] = "\005Title";
static const CHAR stSortAuthor[] = "\006Author";
static const CHAR stSortSaveBy[] = "\015Last Saved by";
static const CHAR stSortCreateDate[] = "\015Creation Date";
static const CHAR stSortSaveDate[] = "\017Last Saved Date";
static const CHAR stSortSize[] = "\004Size";
static const CHAR * const rgstSort[] =
{
	stSortTitle, stSortAuthor, stSortSaveBy,
	stSortCreateDate, stSortSaveDate, stSortSize
};
#else
...
CHAR *szFile;	/* ANSI version of filename */
{
	...
	/* open the file */
		...
		if ((hrgpchLeaves = (CHAR ***)HAllocateCb(
				cLeaves * sizeof(CHAR *))) == hNil)
			goto retFalse;
