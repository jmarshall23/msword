...
#ifdef OPUS_X64
csconst char csmpstyM1st [][16] =
{
	"\010CharLeft", "\010WordLeft", "\010SentLeft", "\006ParaUp",
	"\006LineUp", "\017StartOfDocument", "\015StartOfWindow",
	"\013StartOfLine", "\006PageUp", "\011SectionUp",
#define styM1stMid 10
	"\011CharRight", "\011WordRight", "\011SentRight", "\010ParaDown",
	"\010LineDown", "\015EndOfDocument", "\013EndOfWindow",
	"\011EndOfLine", "\010PageDown", "\013SectionDown"
};
#else
