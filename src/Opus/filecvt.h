...
#define dffOpenWks      -1
#ifdef OPUS_X64
/* Parentheses prevent `dff-dffOpenMin` becoming the modern C token sequence
 * `dff--6` after macro expansion. */
#define dffOpenMin      (-6)
#else
#define dffOpenMin      -6
#endif
...
#define dffSaveRTF      -1
#ifdef OPUS_X64
/* Keep subtraction sites from being retokenized as the -- operator. */
#define dffSaveMin      (-7)
#else
#define dffSaveMin      -7
#endif
