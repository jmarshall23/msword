...
static const Word kDlmInit = 0x0001;
static const Word kDlmTerm = 0x0003;
static const Word kDlmExit = 0x0004;
static const Word kDlmChange = 0x0005;
static const Word kDlmClick = 0x0006;
static const Word kDlmDblClk = 0x0007;
static const Word kDlmSetItemFocus = 0x000b;
static const Word kDlmKillItemFocus = 0x000c;
static const Word kDlmSetDialogFocus = 0x000d;
static const Word kDlmKillDialogFocus = 0x000e;
static const Word kDlmDialogClick = 0x0012;
static const UINT kWmCommitRibbonSelection = WM_APP + 0x352;
static const Word kIddNewDoc = 2;
static const Word kIddOpen = 3;
static const Word kIddSaveAs = 4;
static const Word kIddCharacter = 16;
static const Word kIddApplyStyle = 23;
static const Word kIddDefineStyle = 24;
static const Word kIddAbout = 44;
static const Word kCxtRibbonIconBar = 0x8005;
static const Word kCxtRulerIconBar = 0x8006;
static const Tmc kTmcOk = 1;
static const Tmc kTmcCancel = 2;
static const Tmc kTmcUserMin = 0x0400;
static const Tmc kTmcCharacterName = kTmcUserMin;
static const Tmc kTmcCharacterSize = kTmcUserMin + 2;
static const Tmc kTmcCharacterColor = kTmcUserMin + 4;
static const Tmc kTmcApplyStyle = kTmcUserMin;
static const Tmc kTmcApplyDefine = kTmcUserMin + 2;
static const Tmc kTmcApplyBanter = kTmcUserMin + 3;
static const Tmc kTmcDefineStyle = kTmcUserMin;
static const Tmc kTmcDefineChars = kTmcUserMin + 2;
static const Tmc kTmcDefineParas = kTmcUserMin + 3;
static const Tmc kTmcDefineTabs = kTmcUserMin + 4;
static const Tmc kTmcDefinePosition = kTmcUserMin + 5;
static const Tmc kTmcDefineOptions = kTmcUserMin + 6;
static const Tmc kTmcDefineBanter = kTmcUserMin + 7;
static const Tmc kTmcDefineBasedOn = kTmcUserMin + 8;
static const Tmc kTmcDefineNext = kTmcUserMin + 10;
static const Tmc kTmcDefineTemplate = kTmcUserMin + 12;
static const Tmc kTmcDefineCommit = kTmcUserMin + 13;
static const Tmc kTmcDefineDelete = kTmcUserMin + 14;
static const Tmc kTmcDefineRename = kTmcUserMin + 15;
static const Tmc kTmcDefineMerge = kTmcUserMin + 16;
static const Word kTmmCount = 2;
static const Word kTmmText = 3;
static const Word kUnknownListCount = 0xffff;
static const Tmc kTmcSummary = 0x0400;
static const Tmc kTmcNewDot = 0x0401;
static const Tmc kTmcRNewDoc = 0x0402;
static const Tmc kTmcRNewDot = 0x0403;
static const Tmc kTmcNewType = 0x0404;
static const Tmc kTmcNewTypeList = 0x0405;
static const Tmc kTmcOpenFileName = 0x0400;
static const Tmc kTmcOpenFileList = 0x0401;
static const Tmc kTmcOpenFileDir = 0x0402;
static const Tmc kTmcOpenCatalog = 0x0403;
static const Tmc kTmcOpenReadOnly = 0x0404;
static const Tmc kTmcSaveFile = kTmcUserMin;
static const Tmc kTmcSaveOptions = kTmcUserMin + 1;
static const Tmc kTmcSaveDirectoryText = kTmcUserMin + 2;
static const Tmc kTmcSaveDirectoryList = kTmcUserMin + 3;
static const Tmc kTmcSaveDirectory = kTmcUserMin + 4;
static const Tmc kTmcSaveFormatPrompt = kTmcUserMin + 5;
static const Tmc kTmcSaveFormat = kTmcUserMin + 6;
static const int kSaveFormatRtf = 6;
static const Tmc kTmcSaveQuick = kTmcUserMin + 7;
static const Tmc kTmcSaveBackup = kTmcUserMin + 8;
static const Tmc kTmcSaveLockAnnotations = kTmcUserMin + 9;
static const Word kOpenFileNameIag = 1;
